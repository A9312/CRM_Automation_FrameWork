...
//		String inputProdName = "qsp"+(int)(Math.random()*9999);
		...
		String inputProdName = sh.getRow(2).getCell(0).getStringCellValue()+(int)(Math.random()*9999);
		...
		selCat.selectByValue(sh.getRow(2).getCell(2).getStringCellValue());
		
		WebElement PartNumber = driver.findElement(By.id("productcode"));
		
		PartNumber.sendKeys(sh.getRow(2).getCell(1).getStringCellValue());
		
		WebElement website = driver.findElement(By.name("website"));
		
		website.sendKeys(sh.getRow(2).getCell(3).getStringCellValue());
		...
		UnitPrice.sendKeys(""+sh.getRow(2).getCell(4).getNumericCellValue());
